...
El Dashboard quedo armado de esta mandera:
![CModulo armado](../images/MT07/node-red.png)

Dejo un pequeño video de Node-red controlado el ESP8266 :
Como ventaja es mas vistoso, creo que es aplicable en un centro de control integrado, no me quedo claro la ventaja aún.
https://youtu.be/1Yw8C-kdq2w
[![Ver video](https://img.youtube.com/vi/1Yw8C-kdq2w/0.jpg)](https://youtu.be/1Yw8C-kdq2w)

No practique demasiado como para tener una idea clara.
...
* Sugiero bajar la versin 22.2 de node, con la ultima version me fue imposible hacer que funcionara el DASHBOARD
