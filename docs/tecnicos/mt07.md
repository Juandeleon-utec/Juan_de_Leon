...
Se opto por un rele para simular de manera mas realista una implementacion de IOT para domotica, que fue el enfoque que le di a este trabajo. 
...
![Cascara de Huevo](../images/MT07/paginaweb.png)
...
![Cascara de Huevo](../images/MT07/armado.jpg)
