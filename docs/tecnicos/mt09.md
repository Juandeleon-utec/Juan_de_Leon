...
![Última actualización](https://img.shields.io/github/last-commit/juandeleon-utec/Juan_de_Leon?path=tecnicos/mt09/mt09.md)
...
Como parametro importante aumente la densidad de relleno a 30%, lo que hizo que le impresion tardara 30 minutos mas, aproximadamente, me parecio relevante, ya que esto le confiere algo mas de resistencia, esto debido a problemas que se detallan al final de documento.

!["Molde en CURA"](../images/MT09/Llavero-UltiMakerCura.png "Molde en CURA")

Tambien se habilito "Soporte" ya que la pieza tiene una pequeña perforacion para la salida del aire cuando se vierta el bioplastico.

!["Molde en CURA"](../images/MT09/salida_aire.png "Molde en CURA")
...
Aún no se realizó el llenado con biomaterial, ya que esa parte corresponde a otra materia, pero el molde está listo para ser utilizado en procesos de colada, tambien puede ser necesario algun ajuste, ya que no se la viscosidad del biomaterial.
...
- G-code : https://github.com/Juandeleon-utec/Juan_de_Leon/blob/main/docs/anexos/mt09/CFFFP_Llavero.gcode
...
- Chatgpt : corrección de sintaxis y ortografía.
