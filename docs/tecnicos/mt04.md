...
● Resultado: El LDR funcionó correctamente,
demostrando un cambio brusco en la lectura al exponerlo a
una fuente de luz (simulando la llama). Esto permitió
establecer un umbral de detección fiable.
